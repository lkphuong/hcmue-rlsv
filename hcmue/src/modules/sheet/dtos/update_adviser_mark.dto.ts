...
export class AdviserMarkDtos {
  ...
  @IsNumberValidator({
    message: (arg) =>
      generateValidationMessage(
        arg,
        'Giá trị [điểm đánh giá của cố vấn học tập] phải là số.',
      ),
  })
...
export class UpdateAdviserMarkDto {
  @IsNotEmpty({
    message: (arg) =>
  ...
  @Type(() => AdviserMarkDtos)
  data: AdviserMarkDtos[];
}
