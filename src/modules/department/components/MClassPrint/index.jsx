...
export const MClassPrint = forwardRef(
	({ academic, semester, class_id, department_id, departmentName }, ref) => {
		//#region Data
		...
		return (
			<Box ref={ref} className='print-source' px={4} py={2}>
				...
				<Typography mt={1.5}>
					- Sau khi HĐ ĐGRL KHOA thông qua, sắp xếp theo tuần tự: Khóa học; lớp và chuyển
					danh sách này và file excel về Phòng CTCT-HSSV để tổng hợp và trình HĐ ĐGRL
					Trường xem xét thông qua <b>(Danh sách này lưu tại HĐ Khoa và HĐ Trường).</b>
				</Typography>
