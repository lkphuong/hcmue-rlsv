...
/*
	{index === 2 &&
					ITEMS_DEMO_2.length > 0 &&
					ITEMS_DEMO_2.map((e, i) => (
						<>
							<Grid item xs={6.4}>
								<Typography>- {e.content}</Typography>
							</Grid>
							...
							{e.control === 1 ? (
								...
								<>
									<Grid item xs={1.2} textAlign='center'>
										<TextField disabled={roleId !== 0} />
									</Grid>
									<Grid item xs={1.2} textAlign='center'>
										<TextField disabled={roleId !== 1} />
									</Grid>
									<Grid item xs={1.2} textAlign='center'>
										<TextField disabled={roleId !== 2} />
									</Grid>
								</>
							)}
						</>
				...
				{index === 3 &&
					ITEMS_DEMO_3.length > 0 &&
					ITEMS_DEMO_3.map((e, i) => (
						<>
							<Grid item xs={6.4}>
								<Typography>- {e.content}</Typography>
							</Grid>
